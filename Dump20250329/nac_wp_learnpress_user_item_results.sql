...
DROP TABLE IF EXISTS `wp_learnpress_user_item_results`;
...
LOCK TABLES `wp_learnpress_user_item_results` WRITE;
/*!40000 ALTER TABLE `wp_learnpress_user_item_results` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_learnpress_user_item_results` ENABLE KEYS */;
UNLOCK TABLES;
